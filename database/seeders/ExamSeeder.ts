    ...
    await Exam.createMany([
      {
        ...
        waktu_mulai: dateTime("2023-01-20 08:00:00"),
        waktu_selesai: dateTime("2023-01-20 11:05:00"),
        durasi: 65,
      ...
      },
      {
        ...
        nama_ujian: "UTS TIK Kelas 10",
        waktu_mulai: dateTime("2023-01-21 08:00:00"),
        waktu_selesai: dateTime("2023-01-21 11:05:00"),
        durasi: 65,
